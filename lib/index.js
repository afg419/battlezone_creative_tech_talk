...
var s = function(sketch) {
  ...
  //
  var h = []
    h[0] = new Edge(new Point(new Vector(50,0,25)), new Point(new Vector(100,0,0)));
    h[1] = new Edge(new Point(new Vector(100,0,0)), new Point(new Vector(150,0,25)));
    h[2] = new Edge(new Point(new Vector(150,0,25)), new Point(new Vector(100,0,50)));
    h[3] = new Edge(new Point(new Vector(100,0,50)), new Point(new Vector(50,0,25)));
