...
class LevelLibrary{
  ...
  get level1(){
    var mines = [];
    // (new Mine(new Vector(100,0,0), 1.5, 2)), (new Mine(new Vector(100,50,0), 7, 10))];
    var booty = [
                (new Booty(new Vector(50,0,0), 5, 8, 200)),
                (new Booty(new Vector(100,0,0), 5, 5, 200)),
                (new Booty(new Vector(150,0,0), 5, 5, 200)),
                (new Booty(new Vector(270,30,0), 5, 10, 100)),
                (new Booty(new Vector(300,50,0), 5, 10, 100)),
                (new Booty(new Vector(300,150,0), 5, 10, 100)),
                (new Booty(new Vector(300,250,0), 5, 10, 100)),
                (new Booty(new Vector(300,350,0), 5, 10, 100)),
