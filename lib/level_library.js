...
class LevelLibrary{
  ...
  get level0() {
    ...
    var turrets = [];
    return { mines: mines, booty: booty, turrets: turrets, mothership: [], messages: messages, fighters: []};
  }
  ...
  get level1(){
    ...
    return { mines: mines, booty: booty, turrets: turrets, mothership: [], messages: [], fighters: []};
  }
  ...
  get level3(){
    var mines = this.seedRandomEntities(500, 40, 8, Mine);
    var booty = this.seedRandomEntities(500, 10, 30, Booty);
    var fighters = [
      new Fighter(new Vector(1500, 0, 0), 7, 40, 10, new Vector(125,0,0)),
      new Fighter(new Vector(-1500, 0, 0), 7, 40, 10, new Vector(0,125,0)),
      new Fighter(new Vector(0, 4500, 0), 7, 40, 10, new Vector(150,150,0)),
    ];
    return { mines: mines, booty: booty, turrets: [], mothership: [], messages: [], fighters: fighters };
  }
}
