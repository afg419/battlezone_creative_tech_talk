...
class DisplayGame {
  ...
  setEndGameStatus() {
    if (this.game.win) {
      this.inGame.end_status = "You collected all booty!";
    } else {
  ...
  display(){
    ...
    this.sketch.draw = function(){
      ...
      if(this.gameOver){
        ...
        scores.push({result: result, level: this.inGame.level, wealth: game.player.wealth, time: this.game.gameTimer/20});
