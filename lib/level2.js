...
class Level2{
  ...
  get buildings(){
    var obstacles = []
      ...
      obstacles[2] = new Obstacle(this.build.squareBuilding(-100,-100,100,100,100,true), new Vector(0,0,50))
    return obstacles
  }

  buildingsOrderedBydistanceTo(player){
    return this.buildings.sort( (o1, o2) => o2.distanceTo(player) - o1.distanceTo(player) )
  }
}
